...
add wave -noupdate -expand -group control_unit /test_sample/b2v_inst/clock
add wave -noupdate -expand -group control_unit /test_sample/b2v_inst/instruction
add wave -noupdate -expand -group control_unit /test_sample/b2v_inst/swap_ctrl
add wave -noupdate -expand -group control_unit /test_sample/b2v_inst/set_ctrl
add wave -noupdate -expand -group control_unit /test_sample/b2v_inst/alu_func
add wave -noupdate -expand -group control_unit /test_sample/b2v_inst/alu_spec_func
add wave -noupdate -expand -group control_unit /test_sample/b2v_inst/reg_write_val
add wave -noupdate -expand -group control_unit /test_sample/b2v_inst/alu_src
add wave -noupdate -expand -group control_unit /test_sample/b2v_inst/mem_write
add wave -noupdate -expand -group control_unit /test_sample/b2v_inst/mem_read
add wave -noupdate -expand -group control_unit /test_sample/b2v_inst/branch
add wave -noupdate -expand -group control_unit /test_sample/b2v_inst/reg_write
add wave -noupdate -expand -group control_unit /test_sample/b2v_inst/done_ctrl
add wave -noupdate -expand -group control_unit /test_sample/b2v_inst/jmp_ctrl
add wave -noupdate -expand -group control_unit /test_sample/b2v_inst/opcode
add wave -noupdate -expand -group control_unit /test_sample/b2v_inst/spec_instr
add wave -noupdate -group registerfile /test_sample/b2v_inst12/clock
add wave -noupdate -group registerfile /test_sample/b2v_inst12/write_ctrl
add wave -noupdate -group registerfile /test_sample/b2v_inst12/write_reg
add wave -noupdate -group registerfile /test_sample/b2v_inst12/write_val
add wave -noupdate -group registerfile /test_sample/b2v_inst12/carry_out
add wave -noupdate -group registerfile /test_sample/b2v_inst12/read_reg1
add wave -noupdate -group registerfile /test_sample/b2v_inst12/read_reg2
add wave -noupdate -group registerfile /test_sample/b2v_inst12/swap_ctrl
add wave -noupdate -group registerfile /test_sample/b2v_inst12/set_ctrl
add wave -noupdate -group registerfile /test_sample/b2v_inst12/branch_val
add wave -noupdate -group registerfile /test_sample/b2v_inst12/read_val1
add wave -noupdate -group registerfile /test_sample/b2v_inst12/read_val2
add wave -noupdate -group registerfile /test_sample/b2v_inst12/zero
add wave -noupdate -group registerfile /test_sample/b2v_inst12/imm
add wave -noupdate -group registerfile /test_sample/b2v_inst12/t1
add wave -noupdate -group registerfile /test_sample/b2v_inst12/t2
add wave -noupdate -group registerfile /test_sample/b2v_inst12/s1
add wave -noupdate -group registerfile /test_sample/b2v_inst12/s2
add wave -noupdate -group registerfile /test_sample/b2v_inst12/s3
add wave -noupdate -group registerfile /test_sample/b2v_inst12/branch
add wave -noupdate -expand -group alu /test_sample/b2v_inst19/clock
add wave -noupdate -expand -group alu /test_sample/b2v_inst19/reg1
add wave -noupdate -expand -group alu /test_sample/b2v_inst19/reg2
add wave -noupdate -expand -group alu /test_sample/b2v_inst19/func
add wave -noupdate -expand -group alu /test_sample/b2v_inst19/spec_fun
add wave -noupdate -expand -group alu /test_sample/b2v_inst19/br_out
add wave -noupdate -expand -group alu /test_sample/b2v_inst19/res
add wave -noupdate -expand -group alu /test_sample/b2v_inst19/carry_out
add wave -noupdate -expand -group alu /test_sample/b2v_inst19/result
add wave -noupdate -expand -group if_id /test_sample/b2v_inst3/clock
add wave -noupdate -expand -group if_id /test_sample/b2v_inst3/flush
add wave -noupdate -expand -group if_id /test_sample/b2v_inst3/stall
add wave -noupdate -expand -group if_id /test_sample/b2v_inst3/IF_instruction
add wave -noupdate -expand -group if_id /test_sample/b2v_inst3/ID_instruction
add wave -noupdate -expand -group if_id /test_sample/b2v_inst3/instruction
...
add wave -noupdate -group fetch /test_sample/b2v_inst6/branch_val
add wave -noupdate -group fetch -radix decimal /test_sample/b2v_inst6/instruction_number
add wave -noupdate -group fetch /test_sample/b2v_inst6/cycle_counter
add wave -noupdate -group fetch /test_sample/b2v_inst6/pc
...
add wave -noupdate -group regfile_forwarding /test_sample/b2v_inst15/reg1
